	...
	<div id="content">
		<div class="sub-content show">
			<div class="post is_client_list">
				...
				<div class="post_cell">
					...
					<div class="tab-content drip show">
						...
						<?php if($drip_num_rows==0): ?>
							查無此筆紀錄
						<?php else: ?>
							共有<?=$drip_num_rows?>筆資料！
			...
			<div class="tab-content wsus">
				...
				<div class="record_content">
				<?php if($wsus_num_rows==0): ?>
					查無此筆紀錄
				<?php else: ?>
					共有<?=$wsus_num_rows?>筆資料！
                    <div class='ui relaxed divided list'>
                        <div class='item'>
                            <div class='content'>
                                <div class='header'>
			...
			<div class="tab-content antivirus">
				...
				<div class="record_content">
				<?php if($antivirus_num_rows==0): ?>
					查無此筆紀錄
				<?php else: ?>
					共有<?=$antivirus_num_rows?>筆資料！
					<div class='ui relaxed divided list'>
