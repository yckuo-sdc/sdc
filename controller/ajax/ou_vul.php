...
echo "共有".$rowcount."個單位,".$rowcount_scan."筆掃描設備(含歷史紀錄)！<br><br>";
...
foreach($ou_vuls as $ou_vul) {
	...
	echo "<div class='ou_block red card'>";
		echo  "<div class='content'>";
		    echo "<div class='header'><i class='user circle icon'></i>".$ou_vul['ou']."</div>";
